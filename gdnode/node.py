...
from deprecated.profiles import gdnode
from deprecated.api.core.redis import RedisClient
from deprecated.api.models.var import Var
from deprecated.api.consts import MOVAI_INIT
...
class GDNode:
    ...
    async def main(self, args, unknown) -> None:
        ...
        # if self.transports['ROS2']:
        #     from deprecated.gdnode.protocols.ros2 import ROS2Async
        #     ROS2Async().run_node()
