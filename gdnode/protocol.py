...
import deprecated.gdnode.protocols.base as Base
import deprecated.gdnode.protocols.http as Http
import deprecated.gdnode.protocols.redissub as RedisSub
import deprecated.gdnode.protocols.ros1 as ROS1
import deprecated.gdnode.protocols.movai as MovAI
...
class TransportROS2:
    ...
    def __call__(self, inst_name, **_ignore):
        import deprecated.gdnode.protocols.ros2 as ROS2
        if not self._instance:
